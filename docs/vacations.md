...
<span style="color:red">some **Важно:** text</span> Важно: если вам требуется неоплачиваемый отпуск(он же отгул) более чем на 2 дня, вам нужно написать письменное заявление. Это нужно для бухгалтерии
