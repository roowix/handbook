...
<span style="color:red">**Важно:**</span> Важно: если вам требуется неоплачиваемый отпуск(он же отгул) более чем на 2 дня, вам нужно написать письменное заявление. Этого требует бухгалтерия. 
